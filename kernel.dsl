...
void gspmmw_op(graph_t& graph, array2d_t<float>& input, array1d_t<float>& edge_input, array2d_t<float>& output, op_t op, int64_t reverse);
void gspmmw(graph_t& graph, array1d_t<float>& edge_input, array1d_t<float>& output, op_t op, int64_t reverse);
void gspmmw2d(graph_t& graph, array2d_t<float>& edge_input, array2d_t<float>& output, op_t op, int64_t reverse);
void gspmmw_op2d(graph_t& graph, array3d_t<float>& input, array2d_t<float>& edge_input, array3d_t<float>& output, op_t op, int64_t reverse);
